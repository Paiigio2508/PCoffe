...
public class NhanVienService {
    ...
    public List<NguoiDungAdminRepository> timKiemNV(SearchTenAndTrangThaiRequest nguoiDungSeacrh){
        return nguoiDungRepository.searchNguoiDung(nguoiDungSeacrh,"NHANVIEN");
    }
